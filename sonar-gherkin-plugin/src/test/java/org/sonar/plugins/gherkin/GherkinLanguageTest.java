...
import org.sonar.plugins.gherkin.GherkinLanguage;
...
public class GherkinLanguageTest {
  ...
  public void file_suffix() {
    GherkinLanguage gherkinLanguage = new GherkinLanguage();
    assertThat(gherkinLanguage.getFileSuffixes()).hasSize(1);
    assertThat(gherkinLanguage.getFileSuffixes()[0]).isEqualTo("feature");
  }
